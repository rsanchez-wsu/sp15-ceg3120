...
public class ClientView extends JFrame
{
	...
	public ClientView()
	{
		...
		// create button
		// (KWood) Commented out player.getName as it is not a part of the current Player object. Posted a 
		//			question on the Pilot forum as to whether this should be changed.
		final JButton p1 = new JButton("<html>" + "NAME"/*players.get(0).getName()*/ + "<br>Last Seen:<br>(never)</html>", tankIcon);
		...
		//(kwood) commented player.getName
		final JButton p2 = new JButton("<html>" + "NAME"/*players.get(1).getName()*/ + "<br>Last Seen:<br>(30, 29)</html>", tankIcon);
		...
		//(kwood) commented player.getName
		final JButton p3 = new JButton("<html>" + "NAME"/*players.get(2).getName()*/ + "<br>Last Seen:<br>(12, 33)</html>", tankIcon);
		...
		//(kwood) commented player.getName
		final JButton p4 = new JButton("<html>" + "NAME"/*players.get(3).getName()*/ + "<br>Last Seen:<br>(never)</html>", tankIcon);
		...
		//(kwood) commented player.getName
		final JButton p5 = new JButton("<html>" + "NAME"/*players.get(4).getName()*/ + "<br>Last Seen:<br>(22, 34)</html>", tankIcon);
		...
		//(kwood) commented player.getName
		final JButton p6 = new JButton("<html>" + "NAME"/*players.get(5).getName()*/ + "<br>Last Seen:<br>(never)</html>", tankIcon);
		...
		//(kwood) commented player.getName
		final JButton p7 = new JButton("<html>" + "NAME"/*players.get(6).getName()*/ + "<br>Last Seen:<br>(never)</html>", tankIcon);
		...
		//(kwood) commented player.getName
		final JButton p8 = new JButton("<html>" + "NAME"/*players.get(7).getName()*/ + "<br>Last Seen:<br>(never)</html>", tankIcon);
