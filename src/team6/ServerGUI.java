...
public class ServerGUI extends JPanel {	
    ...
    GameInstance game=new GameInstance();  //having the gameInstance, and data 2d array object is two representations of the same data, should move the 2d array aspect into gameInstance
